<template>
  <div class="bg-white rounded border border-gray-200 relative flex flex-col">
    ...
    <div class="p-6">
      <!-- Upload Dropbox -->
      <div :class="{ 'bg-green-400 border-green-400 border-sold': is_dragover }" @drag.prevent.stop=""
  ...
  methods: {
    upload($event) {
      ...
      files.forEach((file) => {
        ...
        const storageRef = storage.ref("songs");  // music-ba7f0.appspot.com/songs
        const songsRef = storageRef.child(`songs/${file.name}`);  // music-ba7f0.appspot.com/songs/example.mp3
